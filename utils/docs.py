...
stop_words = [
    ...
    'являлось', 'являлись',
    'обладает', 'обладают', 'обладающий', 'обладающая', 'обладающее', 'обладающие', 'обладающего', 'обладающей',
    'обладал', 'обладали', 'обладало', 'обладала', 'обладать',
    'оснащен', 'оснащена', 'оснащено', 'оснащенный', 'оснащенная', 'оснащенные', 'оснащенное',
    'оснащён', 'оснащённый', 'оснащённая', 'оснащённые', 'оснащённое',
    ...
    'оборудовали', 'оборудовал', 'оборудовала', 'оборудуют', 'оборудует', 'оборудовать',
    ...
    'обеспечила', 'обеспечит', 'обеспечат',
